 ...
 */
export function constructDomainContract(params: {
  name: string;
  category: string;
 ...
 */
export function getDomainPartialBytecode(category: string, options: { provider: NetworkProvider; addressType: AddressType }): string
	{
		// Reverse the category bytes for use in contract parameters.
 ...
 */
export function constructContracts(params: {
